...
plates:
  - src: "/plates/hb03-proof-ladder.webp"
    width: 1086
    height: 1448
    alt: "Field-guide plate: scroll plate of the six-rung proof ladder from claim through signal, evidence, repetition, and reliability to institution"
    caption: "Claim to institution — the proof ladder"
    display: half
  - src: "/plates/hb03-map-not-one-score.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: maturity profile chart plotting domains against proof status with a deliberately uneven line, stamped UNEVEN"
    caption: "A map, not one score — the honest silhouette"
    display: full
  - src: "/plates/hb03-evidence-ledger.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: specimen evidence-ledger card with claim, status, evidence, dependencies, failure modes, and next proof fields, stamped RECORDED"
    caption: "The evidence ledger — record what holds, name what is missing"
    display: full
related:
  - stack
  - membership
...
<Plate id="hb03-map-not-one-score" />
