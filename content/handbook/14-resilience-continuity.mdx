...
plates:
  - src: "/plates/hb14-domain-that-answers.webp"
    width: 1536
    height: 1024
    alt: "Field-guide plate: one engraved building with six bays: care for children, the sick, the elderly, emergency response, maintenance, succession"
    caption: "The domain that answers when things break"
    display: full
  - src: "/plates/hb14-continuity-test.webp"
    width: 1536
    height: 1024
    alt: "Field-guide plate: six-spoke wheel of the continuity conditions around the hub question does it still work"
    caption: "The continuity test — does it still work?"
    display: full
  - src: "/plates/hb14-failure-is-evidence.webp"
    width: 1536
    height: 1024
    alt: "Field-guide plate: failure-log specimen card with what broke, the response, time to restore, and what changed, stamped recorded"
    caption: "Failure is evidence — recorded, not narrated"
    display: full
related:
  - maturity
  - governance
...
<Plate id="hb14-domain-that-answers" />
...
<Plate id="hb14-failure-is-evidence" />
