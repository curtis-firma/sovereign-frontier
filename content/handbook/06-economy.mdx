...
plates:
  - src: "/plates/hb06-what-an-economy-must-prove.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: four engraved working stations for production, exchange, treasury, and public goods, with a lone crossed-out coin"
    caption: "What an economy must prove — a token does not prove an economy"
    display: full
  - src: "/plates/hb06-payment-generosity-wage.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: three-column distinctions card separating payment, generosity, and wage"
    caption: "Payment, generosity, wage — three records that must not blur"
    display: full
  - src: "/plates/hb06-useful-excess-and-the-commons.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: network plate routing surplus energy, compute, tools, and time from node to node through a governed commons"
    caption: "Useful excess — what is excess to one node may be capacity to another"
    display: full
  - src: "/plates/hb06-treasury-discipline.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: treasury-vault door posted with transparent ledger, named stewards, spending authority, and review, stamped POSTED"
    caption: "Treasury discipline — trust needs rules in daylight"
    display: full
related:
  - stack
  - starting
...
<Plate id="hb06-what-an-economy-must-prove" />
...
<Plate id="hb06-payment-generosity-wage" />
...
<Plate id="hb06-useful-excess-and-the-commons" />
...
<Plate id="hb06-treasury-discipline" />
