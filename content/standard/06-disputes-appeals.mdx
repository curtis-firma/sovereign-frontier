...
plates:
  - src: "/plates/st06-standard-questions.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: instrument card listing the questions every dispute-resolution arrangement must answer"
    caption: "The standard questions — every dispute arrangement must answer them"
    display: full
  - src: "/plates/st06-jurisdictional-boundary.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: surveyed boundary map between internal process and the surrounding sovereign's law"
    caption: "The jurisdictional boundary — where internal process ends"
    display: full
  - src: "/plates/st06-memory-requirement.webp"
    width: 1448
    height: 1086
    alt: "Field-guide plate: dispute ledger card with a resolved entry, stamped RESOLVED"
    caption: "The memory requirement — a resolution that cannot be remembered cannot bind"
    display: full
related:
  - governance-minimums
  - vectors
...
<Plate id="st06-standard-questions" />
...
<Plate id="st06-jurisdictional-boundary" />
...
<Plate id="st06-memory-requirement" />
