...
const COVERED_SCOPE = ["Realm", "Firmamint", "Settlemint modules", "Governance infrastructure", "Identity and reputation", "Economic interoperability", "Agentic operating system"];
